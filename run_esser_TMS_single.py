# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 10:31:07 2020
...
netParams.popParams['Inh'] = {'cellType': 'Inh', 'numCells': 50, 'cellModel': 'Inhesser'}
...
cellRule = {'conds': {'cellType': 'Inh', 'cellModel': 'Inhesser'},  'secs': {}} 						# cell rule dict
cellRule['secs']['soma'] = {'geom': {}, 'ions':{}, 'pointps': {}, 'vinit':{}}  												# soma params dict
...
np.random.seed(0)
L5_20 = np.random.choice(99,20,replace=False) #20% L5 activated directly 
np.random.seed(1)
L5_40 = np.random.choice(99,40,replace=False) #40% L5 activated directly 
np.random.seed(2)
L5_60 = np.random.choice(99,60,replace=False) #60% L5 activated directly 
#np.random.seed(1)
# netParams.popParams['TMS'] = {'cellModel': 'NetStim', 'interval': 1000, 'noise': 0, 'numCells': 1,'start': 300}  # NetsStim

# netParams.connParams['TMS->L5'] = {
...
sim.analysis.plotRaster(include=[('L23exc'),('inL23exc')],spikeHist='overlay',spikeHistBin = 10,saveData = 'raster_TMSall_single_L23.pkl')
sim.analysis.plotRaster(include=[('L5exc'),('inL5exc')],spikeHist='overlay',spikeHistBin = 10,saveData = 'raster_TMSall_single_L5.pkl')
sim.analysis.plotRaster(include=[('Inh'),('inInh')],spikeHist='overlay',spikeHistBin = 10,saveData = 'raster_TMSall_single_Inh.pkl')
